...
\textbfind{Из предложенного ряда выберите слово, которое является синонимом подчёркнутого слова.}
\vspace{3mm}
...
\textbfind{Выберите правильный вариант из каждой пары. Выбранный вариант подчёркнут.}
\vspace{3mm}
