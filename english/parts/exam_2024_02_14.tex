...
\linksectionold[----- \textit{Февральский зачёт 14.02.2024} -----]{Февральский зачёт 14.02.2024 (Смольская Н.Б.)}

\setcounter{subsection}{1}
\sublinksectionold[------ \textit{Выполненное первое задание} ------]{Выполненное первое задание}
...
\sublinksectionold[------ \textit{Выполненное второе задание} ------]{Выполненное второе задание}
