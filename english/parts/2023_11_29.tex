...
\begin{itemize}[nosep,leftmargin=*,label={}]
	\itemsep\eitsp
	\item immobilize -- \textbf{to} prevent from moving \textit{(perhaps modeled on French immobilizer)}
	\item finite -- limited or bordered by time or any measurements \textit{(from Latin finitum)}
	\item fortify -- \textbf{to} make stronger \textit{(from Latin fortis)}
	\item commemorate -- \textbf{to} honour the memory of smth or someone \textit{(from Latin commemoratus)}
	\item memorandum -- \textit{a} note or record of events written as a reminder \textit{(from Latin memorandum)}
	\item pedestrian -- \textit{a} person who is walking \textit{(from Greek pedi -- ноги)}
...
\newpage
\sublinksection{Порядок слов в предложении}
...
\newpage
\sublinksection{Греческие и латинские заимствования. Продолжение}
...
\hypertarget{ltask:2023-11-29-2}{\textbfind{Выполненное второе задание}} (\hyperref[task:2023-11-29]{\color{blue}{перейти к тексту задания упр.2.6.2.}})
