...
\label{subsec:reported-speech}
{\parindent0pt\includegraphics[width=\textwidth, page=1,trim={0.5in 1.25in 0.6in 1.1in},clip=true]{ReportedSpeechExamples.pdf}}\newpage
...
\hypertarget{ltask:2024-01-17}{--- Выполнение задания ---} (\hyperref[task:2024-01-17]{\color{blue}{перейти к тексту задания}})
\\\\
...
{\parindent0pt\textbf{ПРЕДСТАВЛЕН ТЕКСТ \textcolor{red}{С ОШИБКАМИ}}}
\ \\
...
{\parindent0pt\textbf{ДАЛЕЕ ПРЕДСТАВЛЕН \textcolor{blue}{ИСПРАВЛЕННЫЙ ТЕКСТ}}}
\ \\
...
Нам принципиально важно вот эти три способа запомнить, потому что эти три способа будут присоединять различные типы предложений, о чём мы чуть позже с вами скажем.
...
Тут Present Simple, а я исправил на Past.
На Past Simple.
Почему?
...
Соответственно, будет то, что мы в следующий раз с вами обсудим, и какую-нибудь простенькую, типа University as a Science Centre.
