...
\fancypagestyle{plain}{%
	\fancyhf{}%
	\fancyhead[L]{\phantom{}\notselectableinacrobat{\hyperlink{tocsection.\thesection}{\leftmark}}}%
	\fancyhead[R]{\phantom{}\notselectableinacrobat{\pagelink{subsec:\thesubsection}{\textcolor{violet}{Вернуться к содержанию}}}}%
...
\newcommand{\linksection}[1]{\section{\protect\hyperlink{tocsection.\thesection}{#1}}
\addtocontents{toc}{\protect\pagetarget{sec:\thesection}{}}}

\newcommand{\sublinksection}[1]{\subsection{\protect\hyperlink{tocsubsection.\thesubsection}{#1}}
