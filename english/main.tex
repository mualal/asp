...
\newcommand{\gotolecture}{\color{blue}{\small go to the lecture}}
...
\begin{document}
	...
	\AddToShipoutPicture{\put(3,200){\rotatebox{90}{\scalebox{1}{\pagelink{doc:\thesubsection}{\textcolor{mygray}{\notselectableinacrobat{\rightmark}}}}}}}
	...
	\newpage
	\subfile{parts/2024_03_20.tex}
	\newpage
	\subfile{parts/2024_03_27.tex}
	\newpage
	\subfile{parts/2024_04_03.tex}
	\newpage
	\subfile{parts/2024_04_10.tex}
	\newpage
	\subfile{parts/2024_04_24.tex}
	\newpage
	\subfile{parts/2024_05_14.tex}
	\newpage
	\subfile{parts/2024_06_19.tex}
	\newpage
	
	\fancyhead[R]{\phantom{}\notselectableinacrobat{\hyperlink{tocsubsection.14.4}{\textcolor{mygray2}{Вернуться к содержанию}}}}
	
	\subfile{parts/all_tasks}
	\newpage
	\subfile{parts/topics}
	\newpage
	\subfile{parts/summaries}
	\newpage
